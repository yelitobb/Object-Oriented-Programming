...
class EjemploEvento extends JFrame {
    ...
    public EjemploEvento() {
        ...
        //asigno el pannel a la ventana (Frame)
        ...
        lblPulsaElBoton.setBounds(47, 32, 100, 14);
        ...
        JLabel lblEscribiste = new JLabel("Escribiste los dígitos:");
        lblEscribiste.setBounds(371, 300, 193, 14);
        contentPane.add(lblEscribiste);
        ...
        textField_3.setBounds(371, 335, 193, 20);;
...
public class EventosAnonimasAnidadas{
    /**
